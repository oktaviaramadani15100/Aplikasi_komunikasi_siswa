        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="/tambah_pelanggaran" class="btn btn-success btn-sm" title="Add New Student">
                                ...
                                @foreach ($data as $row)
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: flex; margin-left: -10px;" >
                                            <a href="/tampilkandatapelanggaran/{{$row->id}}" title="Edit Student" style="margin:10px; margin-left: -1px;"><button class="btn btn-primary btn-sm "><img style="width: 20px;" src="{{asset('asset/img/pen.png')}}" alt=""></button></a>      
                                            <a href="/deletepelanggaran/{{$row->id}}"> <button type="submit" class="btn btn-danger btn-sm" title="Delete Student" style="margin:10px; margin-left: -1px;"><img src="{{asset('asset/img/delete.png')}}" alt="" style="width: 20px;"></button></a> 
