                      ...
                      @csrf
                        <div class="mb-3">
                            ...
                            <input disabled type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="nama" value="{{$data->nama_guru}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Matpel</label>
                            <input disabled type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="matapelajaran" value="{{$data->matapelajaran}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">NIP</label>
                            <input disabled type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="nip" value="{{$data->nip}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Tanggal Lahir</label>
                            <input disabled type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="tanggallahir" value="{{$data->tanggallahir}}">
                        </div>
                        <div class="mb-3">
