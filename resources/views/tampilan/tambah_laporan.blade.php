    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="/datapelanggaran" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Data
                    Pelanggaran</a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <form action="/insert_laporan" method="POST">
                     @csrf   
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nama Siswa</label>
                            <select name="siswa_id" id="siswa_id" class="form-control">
                                <option selected>Pilih Siswa</option>
                                @foreach ($inidatasiswa as $l)
                        ...
                        <div class="mb-3">
                            ...
                            <select name="pelanggaran_id" id="pelanggaran_id">
                                <option hidden selected>Pilih Pelanggaran</option>
                                @foreach ($inidatapelanggaran as $j)
                                    <option value="{{ $j->id }}">{{ $j->pelanggaran }}</option>
                                @endforeach
                            </select>
                        </div>
