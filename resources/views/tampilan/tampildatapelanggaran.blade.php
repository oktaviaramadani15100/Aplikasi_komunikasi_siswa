...
<div class="container-xxl position-relative bg-white d-flex p-0">
    ...
    <div class="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9">
                    <form action="/updatedatapelanggaran/{{$data->id}}" method="POST">
                      @csrf
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Pelanggaran</label>
                            <input type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="pelanggaran" value="{{$data->pelanggaran}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Sanksi</label>
                            <input type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="sanksi" value="{{$data->sanksi}}">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Poin</label>
                            <input type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" name="poin" value="{{$data->poin}}">
                        </div>
